...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cp0-xo0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cp0-xo0.containers.anotherwebservice.com/
...
```
git clone git@github.com:moesaif/container-cp0-xo0.git
cd container-cp0-xo0
```
...
```
docker attach container-cp0-xo0
```
